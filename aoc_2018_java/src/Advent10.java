...
public class Advent10 extends JFrame {

	static String input = "position=< 42772, -21149> velocity=<-4,  2>\r\n"
	...
	List<Nisse> nisseList;

	public Advent10() {
		super("Advent10");

		String[] inputArray = input.split("\r\n");
		nisseList = new ArrayList<>();
		for (String s : inputArray) {
			Nisse n = new Nisse();
			n.x = Integer.parseInt(s.split(",")[0].replace("position=<", "").trim());
			n.y = Integer.parseInt(s.split(",")[1].split(">")[0].trim());
			n.velX = Integer.parseInt(s.split("velocity=<")[1].split(",")[0].trim());
			n.velY = Integer.parseInt(s.split("velocity=<")[1].split(",")[1].replace(">", "").trim());
			nisseList.add(n);
		}
		...
		int preIterations = 10645;
		for (Nisse n : nisseList) {
			n.x += n.velX * preIterations;
			n.y += n.velY * preIterations;
		}
...
//				n.y += n.velY;
//			}
//			System.out.println(preIterations + i);
//			repaint();
//			
//			try {
//				Thread.sleep(1000);
...
//		}
	...
	public void paint(Graphics g) {
		...
		int offsetX = 300;
		int offsetY = 300;
		for (Nisse nisse : nisseList) {
			g.fillRect(offsetX + nisse.x * 2, offsetY + nisse.y * 2, 2, 2);
		}
	}
}
